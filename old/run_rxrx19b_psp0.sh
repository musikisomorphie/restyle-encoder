...
--exp_dir=Experiment/non_IID/rxrx19b_psp_4 \
--max_steps=800000 \
--workers=8 \
--batch_size=8 \
--test_batch_size=8 \
...
--dataset_type=rxrx19b \
--encoder_type=ResNetBackboneEncoder \
--exp_dir=Experiment/non_IID/rxrx19b_psp_3 \
--max_steps=800000 \
--workers=8 \
--batch_size=8 \
--test_batch_size=8 \
...
# --dataset_type=rxrx19b \
# --encoder_type=ResNetBackboneEncoder \
# --exp_dir=Experiment/non_IID/rxrx19b_psp_2 \
# --max_steps=800000 \
# --workers=8 \
# --batch_size=8 \
# --test_batch_size=8 \
...
# --dataset_type=rxrx19b \
# --encoder_type=ResNetBackboneEncoder \
# --exp_dir=Experiment/non_IID/rxrx19b_psp_1 \
# --max_steps=800000 \
# --workers=8 \
# --batch_size=8 \
# --test_batch_size=8 \
...
# --dataset_type=rxrx19b \
# --encoder_type=ResNetBackboneEncoder \
# --exp_dir=Experiment/non_IID/rxrx19b_psp_0 \
# --max_steps=800000 \
# --workers=8 \
# --batch_size=8 \
# --test_batch_size=8 \
